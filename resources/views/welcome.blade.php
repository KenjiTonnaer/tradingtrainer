<x-layouts.guest>
    <x-slot:title>TradingTrainer - Train, Learn & Master Trading</x-slot:title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-2 text-2xl font-bold text-gray-900">TradingTrainer</span>
                </div>
                ...
                @if (Route::has('login'))
                    <div class="flex items-center space-x-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-gray-700 hover:text-primary-600 font-medium transition">
                                Dashboard
                            </a>
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="bg-primary-600 text-white px-6 py-2 rounded-lg hover:bg-primary-700 font-medium transition shadow-sm">
                                    Gratis Starten
                                </a>
                            @endif
                        @endauth
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                        Master Trading Zonder Risico
                    </h1>
                    <p class="text-xl text-primary-100 mb-8 leading-relaxed">
                        Train je trading skills in een realistische omgeving zonder echt geld te verliezen.
                        Leer strategieën, ontwikkel discipline en word een betere trader.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="bg-white text-primary-700 px-8 py-4 rounded-lg hover:bg-gray-100 font-semibold text-lg transition shadow-lg text-center">
                                Start Nu Gratis
                            </a>
                        @endif
                        <a href="#features" class="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white hover:text-primary-700 font-semibold text-lg transition text-center">
                            Ontdek Meer
                        </a>
                    </div>
                </div>
                <div class="hidden lg:block">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                        <svg class="w-full h-64 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">Waarom TradingTrainer?</h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                    Alles wat je nodig hebt om een succesvolle trader te worden, zonder risico
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Virtueel Geld</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Oefen met virtueel saldo. Maak alle fouten die je moet maken zonder financiële consequenties.
                    </p>
                </div>

                <!-- Feature 2 -->
                <div class="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition">
                    <div class="bg-success-100 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Train met realistische marktscenario's en historische data om je vaardigheden te verbeteren.
                    </p>
                </div>

                <!-- Feature 3 -->
                <div class="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition">
                    <div class="bg-purple-100 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Track Progress</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Volg je prestaties, analyseer je trades en leer van je fouten met gedetailleerde statistieken.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-3 gap-8 text-center">
                <div>
                    ...
                    <div class="text-primary-100 text-lg">Actieve Traders</div>
                </div>
                <div>
                    <div class="text-5xl font-bold mb-2">1M+</div>
                    <div class="text-primary-100 text-lg">Trades Uitgevoerd</div>
                </div>
                <div>
                    <div class="text-5xl font-bold mb-2">98%</div>
                    <div class="text-primary-100 text-lg">Tevredenheid</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">Hoe Werkt Het?</h2>
                <p class="text-xl text-gray-600">Drie simpele stappen naar trading succes</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                <!-- Step 1 -->
                <div class="text-center">
                    <div class="bg-primary-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">
                        1
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Registreer Gratis</h3>
                    <p class="text-gray-600">
                        Maak een account aan en krijg direct toegang tot je virtuele trading account.
                    </p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Start Met Oefenen</h3>
                    <p class="text-gray-600">
                        Begin met traden in een veilige omgeving zonder financieel risico.
                    </p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Verbeter Skills</h3>
                    <p class="text-gray-600">
                        Analyseer je resultaten en word steeds beter in je trading strategieën.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">
                Word lid van duizenden traders die hun skills verbeteren met TradingTrainer
            </p>
            @if (Route::has('register'))
                <a href="{{ route('register') }}" class="inline-block bg-primary-600 text-white px-10 py-4 rounded-lg hover:bg-primary-700 font-semibold text-lg transition shadow-lg">
                    Start Vandaag Gratis
                </a>
            @endif
            <p class="text-gray-500 mt-4">Geen creditcard vereist • 100% gratis om te starten</p>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    <div class="flex items-center mb-4">
                        ...
                        <span class="ml-2 text-xl font-bold">TradingTrainer</span>
                    </div>
                    <p class="text-gray-400">
                        Leer traden zonder risico
                    </p>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-white transition">Prijzen</a></li>
                        <li><a href="#" class="hover:text-white transition">FAQ</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="font-semibold mb-4">Bedrijf</h4>
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="#" class="hover:text-white transition">Over Ons</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-white transition">Voorwaarden</a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-gray-800 pt-8 text-center text-gray-400">
                <p>&copy; {{ date('Y') }} TradingTrainer. Alle rechten voorbehouden.</p>
            </div>
        </div>
    </footer>
