        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
            <div class="text-center">
                <h1 class="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight">
                    Meester je Trading Skills
                    <span class="block text-yellow-300 mt-2">Zonder Risico</span>
                </h1>
                <p class="text-xl md:text-2xl text-purple-100 mb-10 max-w-3xl mx-auto">
                    Train je trading strategieën met real-time marktdata en verbeter je vaardigheden voordat je echt geld investeert.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="{{ route('register') }}" class="group relative inline-flex items-center px-8 py-4 bg-white text-purple-600 text-lg font-bold rounded-full hover:bg-yellow-300 hover:text-purple-700 transition-all duration-300 transform hover:scale-105 shadow-2xl">
                        <span>Start Gratis Training</span>
                ...
                <div class="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                        ...
                        <div class="text-purple-100 font-medium">Actieve Traders</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                        <div class="text-4xl font-bold text-yellow-300 mb-2">1M+</div>
                        <div class="text-purple-100 font-medium">Gesimuleerde Trades</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                        <div class="text-4xl font-bold text-yellow-300 mb-2">95%</div>
                        <div class="text-purple-100 font-medium">Tevredenheid</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                    Waarom TradingTrainer?
                </h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                    Alles wat je nodig hebt om een succesvolle trader te worden
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Train met echte marktdata en leer hoe je reageert op real-time marktbewegingen.
                    </p>
                </div>

                <!-- Feature 2 -->
                <div class="group p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-yellow-50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Veilig Oefenen</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Geen risico's, geen verliezen. Ontwikkel je strategieën met virtueel geld.
                    </p>
                </div>

                <!-- Feature 3 -->
                <div class="group p-8 rounded-2xl bg-gradient-to-br from-pink-50 to-purple-50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Analyseer je prestaties en ontdek waar je kunt verbeteren met gedetailleerde statistieken.
                    </p>
                </div>

                <!-- Feature 4 -->
                <div class="group p-8 rounded-2xl bg-gradient-to-br from-yellow-50 to-orange-50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">Leer Strategieën</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Toegang tot tutorials en lesmaterialen om je trading kennis te vergroten.
                    </p>
                </div>

                <!-- Feature 5 -->
                <div class="group p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-orange-50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-orange-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Leer van anderen, deel ervaringen en groei samen met een community van traders.
                    </p>
                </div>

                <!-- Feature 6 -->
                <div class="group p-8 rounded-2xl bg-gradient-to-br from-pink-50 to-yellow-50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="w-14 h-14 bg-gradient-to-br from-pink-500 to-yellow-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">24/7 Beschikbaar</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Train wanneer het jou uitkomt. Onze platform is altijd beschikbaar.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="relative py-24 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-purple-100 mb-10 max-w-2xl mx-auto">
                Sluit je aan bij duizenden traders die hun vaardigheden verbeteren met TradingTrainer. Start vandaag nog gratis!
            </p>
            <a href="{{ route('register') }}" class="inline-flex items-center px-10 py-5 bg-white text-purple-600 text-xl font-bold rounded-full hover:bg-yellow-300 hover:text-purple-700 transition-all duration-300 transform hover:scale-110 shadow-2xl">
                <span>Begin Je Trading Journey</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">
                        Meester je trading skills zonder risico.
                    </p>
                </div>
                <div>
                    <h3 class="text-white font-bold mb-4">Quick Links</h3>
                    <ul class="space-y-2">
                        <li><a href="#" class="hover:text-purple-400 transition">Over Ons</a></li>
                        <li><a href="#features" class="hover:text-purple-400 transition">Features</a></li>
                        <li><a href="#" class="hover:text-purple-400 transition">Prijzen</a></li>
